...
$LAB
    ...
    // Load required js
    .script($js_path + 'webplate-jquery.js').wait()
    .script($js_path + 'webplate-modernizer.js').wait()
...
//                    });
    ...
    .wait(function(){
        ...
        // Load webplate LESS
        $('head').append('<link rel="stylesheet" href="'+ $css_path +'webplate-imports.less" type="text/less" />');
