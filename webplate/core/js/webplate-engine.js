	...
	complete							: function(){
		...
		if(($css_extras) && ($css_extras.length > 0)){
			...
			yepnope({ load: $ar_css_extras, complete: function(){
				...
				// Manage touch navigation
				if(Modernizr.touch){
	
					$.web_navigation_touch();
				}
			} });
		}
		else {
